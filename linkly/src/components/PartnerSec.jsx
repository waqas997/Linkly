...
export default function PartnerSec() {
  return (
    <div className="main-container pt-16 pb-8">
      <div>
        ...
        <div className="text-center mt-12 land:mt-20">
            ...
            <button className="bg-[#1361F5] inter500 text-[12px] land:text-[18px] text-white px-5 py-2 rounded-full">Get Started for Free</button>
