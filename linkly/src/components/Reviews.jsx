...
export default function Reviews() {
  return (
    <div style={{backgroundImage:`url('${img}')`,backgroundPosition:"100% 94%",backgroundSize:"cover"}}>
        ...
        >
          ...
          <div className=" ">
            <p className="text-[#6D6D6D] md:text-[12px] land:text-[18px] ">
              ...
              developer/owner of Linkly is very responsive and developed helpful
              features quickly, following our request. Very cool.”
            </p>
            <hr className="my-4" />
            <div className="flex items-center gap-4">
              <div className="w-[36px] h-[36px] rounded-full bg-[#7562e0]"></div>
        ...
        >
          ...
          <div className="">
            <p className="text-[#1d1d1d] md:text-[14px] land:text-[18px] inter500">
              ...
              have access to and pixel all of them centrally. Linkly is a clean,
              easy way of doing that quickly and cheaply.”
            </p>
            <hr className="my-4" />
            <div className="flex items-center gap-4">
              <div className="w-[36px] h-[36px] rounded-full bg-[#7562e0]"></div>
      ...
      <div className="grid main-container mt-5">
        ...
        >
          <div>
            <p className="text-[#6D6D6D] md:text-[12px] land:text-[18px]">
              “This software it remarkably easy to use and would be a great
              choice for any marketer who wants to be able to track link metrics
              without losing brand integrity.”
            </p>
            <hr className="my-4" />
            <div className="flex items-center gap-4">
              <div className="w-[36px] h-[36px] rounded-full bg-[#7562e0]"></div>
