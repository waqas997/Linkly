...
<div className="relative">
    <div className="h-72 w-full absolute bottom-0 flex flex-col  justify-end items-center text-center" style={{
      background: 'linear-gradient(rgba(231, 242, 249, .3) , #E3F1FA 100%)',
        ...
        <h2 className="inter500  land:text-[30px] text-[#1d1d1d]">...and thousands of other integrations available via Zapier</h2>
        <button onClick={handleDisplay} className="flex items-center gap-3 px-5 py-2 rounded-full mt-4 bg-[#1361f5] text-white text-[12px] land:text-[18px]">Learn more <svg xmlns="http://www.w3.org/2000/svg" width="19" height="13" viewBox="0 0 19 13" fill="none">
